...
const Container = styled.div`
  ...
  background: ${colors.black}; padding: 2rem;
`;

const Card = styled.div`
  background: ${colors.white}; width: 100%; max-width: 420px;
  border: 3px solid ${colors.black};
`;

const Header = styled.div`
  background: ${colors.black}; padding: 2rem; text-align: center;
`;

const Logo = styled.h1`
  font-family: 'Oswald', sans-serif; font-size: 2rem; font-weight: 700;
  color: ${colors.white}; text-transform: uppercase; letter-spacing: 0.05em;
  span { color: ${colors.red}; }
`;

const Subtitle = styled.p`
  font-family: 'Inter', sans-serif; font-size: 0.75rem; color: ${colors.gray};
  text-transform: uppercase; letter-spacing: 0.15em; margin-top: 0.5rem;
`;
...
const Input = styled.input`
  width: 100%; padding: 1rem; background: ${colors.background};
  border: 2px solid ${colors.lightGray}; font-family: 'Inter', sans-serif;
  font-size: 1rem; color: ${colors.black}; transition: all 0.2s ease;
  &:focus { outline: none; border-color: ${colors.black}; background: ${colors.white}; }
`;

const Button = styled.button`
  width: 100%; padding: 1rem; font-family: 'Oswald', sans-serif; font-size: 1rem;
...
const ErrorBox = styled.div`
  font-family: 'Inter', sans-serif; font-size: 0.85rem; color: ${colors.red};
  background: ${colors.red}15; padding: 0.75rem 1rem; border: 1px solid ${colors.red};
`;
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <FormGroup>
              ...
              <Input type="email" value={email} onChange={e => setEmail(e.target.value)}
                placeholder="admin@iverlasting.de" required autoFocus />
            </FormGroup>
            <FormGroup>
