...
const Logo = styled(Link)`font-family: 'Roboto', 'Arial Black', sans-serif; font-size: 1.75rem; font-weight: 700; color: ${colors.white}; text-decoration: none; letter-spacing: -2px; padding: 1rem 0;`;
